...
#      "sudo service nginx start",
      ...
      "sudo /usr/bin/npm install -g @angular/cli@7.3.9",
      "sudo cd /tmp/cas-demo-application && /usr/bin/npm install",
      "sudo /usr/bin/ng build --prod",
      "sudo /bin/cp -R /tmp/cas-demo-application/dist/cmbu-demo-application/ /usr/share/nginx/html/",
